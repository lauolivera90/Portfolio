  ...
  return (
    <footer className="border-t border-text/10 bg-text/5">
      <div className="max-w-6xl mx-auto px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
        <p className="text-xs text-text/60">© 2026 Alex Kim. All rights reserved.</p>
        <div className="flex items-center gap-3">
          {[
            ...
            <a
              ...
              href={href}
              aria-label={label}
              className="w-9 h-9 flex items-center justify-center rounded border border-text/10 text-text/60 hover:text-text hover:border-primary/50 transition-colors"
            >
              {icon}
            </a>
          ))}
