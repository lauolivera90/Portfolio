...
const TAGS_MOCK = ['React', 'TypeScript', 'Node.js']

export function ProjectCard({ project, onVerMas }) {
  return (
    <Card variant="raised" className="hover:border-primary/40 transition-colors">
      <CardBody>
        <img
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex gap-3">
              <Button variant="primary" className="flex-1" href={project.demo} icon={<IconExternalLink />}>
                Live demo
              </Button>
