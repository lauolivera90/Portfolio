...
- **Timeline:** sección horizontal en `lg`+ (vertical en mobile) con línea neutra `bg-text/10`. El marker de cada hito es un punto chico (`w-3 h-3 rounded-full`): neutral `bg-text/30` para años pasados y `bg-primary ring-4 ring-primary/20` para el hito actual (último de la lista). Fechas con mes + año (`text-xs` accent, ejemplo "May 2016").
